  ...
  var has3d,
    ...
    turnMethods = {
      ...
      _addMotionPage: function () {
        var opts = $(this).data().f.opts,
          turn = opts.turn,
          dd = turn.data(); // eslint-disable-line no-unused-vars
      ...
      _eventEnd: function (e, opts, turned) {
        var that = $(e.target),
          data = that.data().f, // eslint-disable-line no-unused-vars
          turn = opts.turn,
          dd = turn.data();
      ...
      _eventPressed: function (e) {
        var page, // eslint-disable-line no-unused-vars
          data = $(e.target).data().f,
          turn = data.opts.turn,
          turnData = turn.data(),
          pages = turnData.pages; // eslint-disable-line no-unused-vars
      ...
      update: function () {
        ...
        if (this.turn("animating") && data.pageMv[0] !== 0) {
          ...
          var p,
            apage, // eslint-disable-line no-unused-vars
            fixed,
    ...
    flipMethods = {
      ...
      _addPageWrapper: function () {
        var att, // eslint-disable-line no-unused-vars
          data = this.data().f,
          turnData = data.opts.turn.data(),
          parent = this.parent();
        ...
        switch (data.effect) {
          ...
          case "sheet":
            var that = this,
              a = 0,
              alpha = 0,
              beta, // eslint-disable-line no-unused-vars
              px,
              gradientEndPointA,
              gradientEndPointB,
              gradientStartVal,
              ...
              tan = Math.tan(alpha), // eslint-disable-line no-unused-vars
